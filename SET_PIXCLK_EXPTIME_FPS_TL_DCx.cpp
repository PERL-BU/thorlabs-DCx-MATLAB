...
//mex 'SET_PIXCLK_EXPTIME_FPS_TL_DCx.cpp' 'uc480.lib'
...
{     
    ...
    if (error != IS_SUCCESS) { mexErrMsgTxt("Error getting frame rate info"); }
      mexPrintf("Original frame rate: %d \n", fps_actual);
